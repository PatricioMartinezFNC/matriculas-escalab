...
import com.escalab.matriculas.exception.AuthException;
...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
	...
	public void configure(HttpSecurity http) throws Exception {
		...
		.authorizeRequests()
				...
				.antMatchers("/clase/**").authenticated()
				.antMatchers("/estudiante/").authenticated()
				.antMatchers("/maestro/**").authenticated()
				.antMatchers("/matricula/**").authenticated()
				.antMatchers("/seccion/**").authenticated();
	}
